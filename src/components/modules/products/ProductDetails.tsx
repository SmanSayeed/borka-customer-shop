...
const [zoomed, setZoomed] = useState(false);
  ...
  return (
    <div className='container mx-auto mt-16 grid grid-cols-1 lg:grid-cols-2 gap-6'>
      {/* Left Section - Images */}
        ...
        <div className='flex gap-10 mb-4'>
          ...
          <div>
            <p className='font-medium mb-2'>
              Colors:{' '}
              <span className='text-gray-500'>{selectedColor || 'Select'}</span>
            </p>
          ...
          <div>
            <p className='font-medium mb-2'>
              Size:{' '}
              <span className='text-gray-500'>{selectedSize || 'Select'}</span>
            </p>
            <div className='flex gap-2'>
        ...
        <Tabs defaultValue='description' className='w-full'>
          ...
          <TabsContent value='offers'>
            <ul className='text-sm text-gray-600 space-y-2'>
              ...
              <li>
                🎁 <strong>Special Offer:</strong> Buy 2 get 1 free on selected
                items.
              </li>
              <li>
