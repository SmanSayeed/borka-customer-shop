...
const CheckoutDetails = () => {
  ...
  return (
    <div className='container mx-auto mb-6 lg:mb-12'>
      ...
      <Dialog open={isCartEmptyModalOpen} onOpenChange={setCartEmptyModalOpen}>
        <DialogContent className='sm:max-w-[400px] text-center'>
          ...
          <p className='my-4 text-red-600'>
            Your cart is empty. Please add some products before placing an
            order.
          </p>
          <DialogFooter className='flex justify-center'>
            <Button onClick={() => setCartEmptyModalOpen(false)}>
              Go Back
            </Button>
          </DialogFooter>
        </DialogContent>
