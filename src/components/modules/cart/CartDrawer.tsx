          ...
          <DrawerHeader className='flex items-center justify-between'>
            <div className='flex items-center justify-between gap-16'>
              <div className='text-left'>
                <DrawerTitle className='text-xl font-bold text-primary flex items-center gap-2'>
              ...
              <DrawerClose asChild>
                <button className='rounded-full p-2 hover:bg-destructive hover:text-white'>
